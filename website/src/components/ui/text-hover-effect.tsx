    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor={"#001c32"} />
              <stop offset="25%" stopColor={"#00cbdd"} />
              <stop offset="50%" stopColor={"#00031b"} />
              <stop offset="75%" stopColor={"#005a6b"} />
              <stop offset="100%" stopColor={"#00cbdd"} />
            </>
          )}
        </linearGradient>
