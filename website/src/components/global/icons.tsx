...
const Icons: IconType = {
  logo: (props: LucideProps) => (
    ...
    >
      ...
      <path
        d="M12 6.5C9.51 6.5 7.5 8.51 7.5 11C7.5 11.83 7.73 12.59 8.13 13.24C8.4 13.68 8.53 14.2 8.53 14.71V15.5C8.53 16.33 9.2 17 10.03 17H13.97C14.8 17 15.47 16.33 15.47 15.5V14.71C15.47 14.2 15.6 13.68 15.87 13.24C16.27 12.59 16.5 11.83 16.5 11C16.5 8.51 14.49 6.5 12 6.5ZM13.97 15.5H10.03V14.71C10.03 13.9 9.82 13.09 9.4 12.38C9.17 11.99 9.03 11.51 9.03 11C9.03 9.34 10.34 8.03 12 8.03C13.66 8.03 14.97 9.34 14.97 11C14.97 11.51 14.83 11.99 14.6 12.38C14.18 13.09 13.97 13.9 13.97 14.71V15.5Z"
        fill="currentColor"
        data-oid="zfk222:"
      />
  ...
  discord: (props: LucideProps) => (
    <svg
      ...
      data-oid="udp::q1"
    >
      <g fill="none" fillRule="evenodd" data-oid="e1qkhrd">
        <path
  ...
  gmail: (props: LucideProps) => (
    <svg
      ...
      data-oid="rj72vc_"
    >
      <g fill="none" fillRule="evenodd" data-oid="ki-ybpg">
        <g fillRule="nonzero" data-oid="vj2:8vm">
          <path
            fill="#4285f4"
  ...
  outlook: (props: LucideProps) => (
    ...
    >
      ...
      <path fill="#0078d4" d="M10 5h7v6h-7z" data-oid="7aibv9t" />
      <path fill="#50d9ff" d="M24 5h6v6h-6z" data-oid="qel2owu" />
      <path
        fill="#0364b8"
        d="m24 17-7-6h-7v6l7 6 10.832 1.768z"
        data-oid=".r2a0ts"
      />

      <path fill="none" d="M10.031 5H30" data-oid="rhhy5yw" />
      <path fill="#0078d4" d="M17 11h7v6h-7z" data-oid="gam1lsz" />
      <path fill="#064a8c" d="M10 17h7v6h-7z" data-oid="2jz4zu4" />
      <path fill="#0078d4" d="M24 17h6v6h-6z" data-oid=":wizhgq" />
      <path
        fill="#0a2767"
      ...
      <path fill="none" d="M0 0h32v32H0z" data-oid="_7vj6.t" />
    </svg>
  ),
};
