...
interface SecondLoaderProps {
  className?: string;
  logoColor?: string;
}

const SecondLoader = ({ className, logoColor = "grey" }: SecondLoaderProps) => {
  return (
    <div className={cn("loader", className)} style={{ "--logo-color": logoColor } as React.CSSProperties}>
      <div className="box">
        <div className="logo">
          <svg
