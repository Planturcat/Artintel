...
/**
 * Modal shown when a user enters the wrong password
 */
export default function WrongPasswordModal({ email, onClose }: WrongPasswordModalProps) {
  return (
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300 mb-2">
              The password you entered for <span className="font-medium text-white">{email}</span> is incorrect.
            </p>
